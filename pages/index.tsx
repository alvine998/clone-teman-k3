    ...
    <div className='relative'>
      <div className={`w-full ${open ? "h-100 absolute" : "h-20"} transition-all duration-300 p-2 bg-[#15406A]`}>
        <div className='flex justify-between items-center'>
          ...
          <button onClick={() => {
            setOpen(!open)
          }} className='border border-[#FFFFFF8C] focus:border-2 p-2 rounded-md w-16 flex items-center justify-center'>
      ...
      <div className={`p-4 ${open ? "pt-24" : ""} `}>
        <h1 className='text-3xl text-[#5a5a5a] text-center font-semibold'>Hasil Scan QRCODE Personel</h1>
        <div className='border-4 border-[#15406A] rounded-lg bg-white mt-2'>
